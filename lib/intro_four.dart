            ...
            child: Column(
                children: [
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          child: Center(child: Text('4', style: TextStyle(color: Colors.white,fontSize: 18,fontFamily: 'Lexend_Medium'))),
                        ),
                  ...
                  Container(
                    ...
                    height: 66,
                    child: Image.asset("assets/images/bg_southindian.png",width: MediaQuery.of(context).size.width,),
                  ),
                  Container(
                    margin: EdgeInsets.all(20),
                    child: Image.asset("assets/images/southindian_food.png",width: MediaQuery.of(context).size.width,),
                  ),
                  Container(
                    margin: EdgeInsets.all(20),
                    ...
                    child: Center(
                      child: InkWell(
                        ...
                        child: Container(
                          ...
                          child: Text("Continue",style:TextStyle(fontSize: 22,color: Colors.white ,fontFamily: 'Lexend_Medium')),
                        ),
                      ),
                    ),
                  )
