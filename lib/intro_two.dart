...
import 'package:resutarant/intro_three.dart';
            ...
            child: Column(
                children: [
                  ...
                  Container(
                    ...
                    height: 66,
                    child: Image.asset("assets/images/bg_punjabi.png",width: MediaQuery.of(context).size.width,),
                  ),
                  Container(
                    margin: EdgeInsets.all(20),
                    child: Image.asset("assets/images/panjabi_food.png",width: MediaQuery.of(context).size.width,),
                  ),
                  Container(
                    margin: EdgeInsets.all(20),
